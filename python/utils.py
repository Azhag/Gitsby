...
Created by Loic Matthey on 2013-04-11.
...
def email_finished(text='Work complete', to='', subject='Work complete'):
    '''
        Sends an email to the given email address.
    '''

    assert to, "Provide a destination email address!"
    
    sender = 'robot@gatsby.ucl.ac.uk'
    receivers = [to]
